...
func (*SilentPush) Descriptor() ([]byte, []int) {
	return fileDescriptorPushService, []int{0}
}

type Localizeable struct {
	LocKey  string   `protobuf:"bytes,1,opt,name=locKey,proto3" json:"locKey,omitempty"`
	LocArgs []string `protobuf:"bytes,2,rep,name=locArgs" json:"locArgs,omitempty"`
}
...
func (*Localizeable) Descriptor() ([]byte, []int) {
	return fileDescriptorPushService, []int{1}
}
...
type AlertingPush struct {
	...
	AlertBody  isAlertingPush_AlertBody `protobuf_oneof:"alertBody"`
	// Types that are valid to be assigned to AlertTitle:
	//	*AlertingPush_LocAlertTitle
	//	*AlertingPush_SimpleAlertTitle
	AlertTitle isAlertingPush_AlertTitle `protobuf_oneof:"alertTitle"`
...
func (*AlertingPush) Descriptor() ([]byte, []int) {
	return fileDescriptorPushService, []int{2}
}
...
type AlertingPush_LocAlertBody struct {
	LocAlertBody *Localizeable `protobuf:"bytes,1,opt,name=locAlertBody,oneof"`
}
type AlertingPush_SimpleAlertBody struct {
	SimpleAlertBody string `protobuf:"bytes,2,opt,name=simpleAlertBody,proto3,oneof"`
}
type AlertingPush_LocAlertTitle struct {
	LocAlertTitle *Localizeable `protobuf:"bytes,3,opt,name=locAlertTitle,oneof"`
}
type AlertingPush_SimpleAlertTitle struct {
	SimpleAlertTitle string `protobuf:"bytes,4,opt,name=simpleAlertTitle,proto3,oneof"`
}
...
func _AlertingPush_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 1: // alertBody.locAlertBody
		...
		return true, err
	case 2: // alertBody.simpleAlertBody
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		...
		return true, err
	case 3: // alertTitle.locAlertTitle
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(Localizeable)
		...
		return true, err
	case 4: // alertTitle.simpleAlertTitle
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		x, err := b.DecodeStringBytes()
...
type VoipPush struct {
	...
	AttemptIndex int32 `protobuf:"varint,2,opt,name=attemptIndex,proto3" json:"attemptIndex,omitempty"`
}
...
func (*VoipPush) Descriptor() ([]byte, []int) {
	return fileDescriptorPushService, []int{3}
}
...
type PushBody struct {
	...
	TimeToLive  int32  `protobuf:"varint,2,opt,name=timeToLive,proto3" json:"timeToLive,omitempty"`
...
func (*PushBody) Descriptor() ([]byte, []int) {
	return fileDescriptorPushService, []int{4}
}
...
type PushBody_SilentPush struct {
	SilentPush *SilentPush `protobuf:"bytes,4,opt,name=silentPush,oneof"`
}
type PushBody_AlertingPush struct {
	AlertingPush *AlertingPush `protobuf:"bytes,5,opt,name=alertingPush,oneof"`
}
type PushBody_VoipPush struct {
	VoipPush *VoipPush `protobuf:"bytes,6,opt,name=voipPush,oneof"`
}
...
func (*DeviceIdList) Descriptor() ([]byte, []int) {
	return fileDescriptorPushService, []int{5}
}
...
func (*Push) Descriptor() ([]byte, []int) {
	return fileDescriptorPushService, []int{6}
}
...
type Response struct {
	ProjectInvalidations map[string]*DeviceIdList `protobuf:"bytes,1,rep,name=projectInvalidations" json:"projectInvalidations,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptorPushService, []int{7}
}
...
func (*PingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptorPushService, []int{8}
}
...
func (*PongResponse) Descriptor() ([]byte, []int) {
	return fileDescriptorPushService, []int{9}
}
...
func init() {
	proto.RegisterFile("push_service.proto", fileDescriptorPushService)
}

var fileDescriptorPushService = []byte{
	// 672 bytes of a gzipped FileDescriptorProto
	,
}
